...
import com.android.smartstudy.ui.presentation.components.TaskCheckBox
import com.android.smartstudy.ui.presentation.components.TaskDatePicker
import com.android.smartstudy.util.Priority
import com.android.smartstudy.util.SnackbarEvent
import com.android.smartstudy.util.changeMillsToDateString
...
data class TaskScreenNavArgs(val taskId: Int?, val subjectId: Int?)
...
private fun TaskScreen(
    ...
    DeleteDialog(
        ...
        title = "Delete Task",
        bodyText = "Are you sure, you want to delete this task? " + "This action can noy be undone",
    ...
    Scaffold(snackbarHost = { SnackbarHost(hostState = snackbarHostState) }, topBar = {
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                singleLine = true,
                isError = taskTitleError != null && state.title.isNotEmpty(),
